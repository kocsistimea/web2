            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="telefonszam" class="col-md-4 col-form-label text-md-right">{{ __('Telefonszám') }}</label>

                            <div class="col-md-6">
                                <input id="telefonszam" type="telefonszam" class="form-control{{ $errors->has('telefonszam') ? ' is-invalid' : '' }}" name="telefonszam" value="{{ old('telefonszam') }}" required>

                                @if ($errors->has('telefonszam'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('telefonszam') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
